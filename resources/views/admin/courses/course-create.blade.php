                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <form method="post" action="{{ route('courses.save') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="course_name" id="course_name" placeholder="Enter Course">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="amount" id="amount" placeholder="Enter Course Amount">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="course_time" id="course_time" placeholder="Enter Course Time">
